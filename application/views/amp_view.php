...
<html amp>
	<meta charset="utf-8">
	<title><?php echo strip_tags($contentDetails['title']); ?> | edexlive</title>
	...
	<meta name="twitter:site" content="Edex Live" />
	<meta name="twitter:creator" content="@xpress_edex" />
	...
	<style amp-custom>
		@font-face{ font-family: FrancoisOne; src: url(<?php echo image_url ?>css/FrontEnd/fonts/FrancoisOne-Regular.ttf);}
		@font-face{ font-family: domine; src: url(<?php echo image_url ?>css/FrontEnd/fonts/Domine-Regular.ttf);}
		body{font-family: FrancoisOne;}
		header{float:left;width:100%;padding:2% 2% 0;}
		header .menu-bar{font-size: 31px;color: #f4981d;float: left;margin-left: 2%;}
		header .logo_img{float: left;margin-left: 20%;}
		header .logo_img img{margin-top: -5%;}
		header hr{float: left;width: 95%;border:none;border-top: 2px solid #f4981d;border-radius: 8px;margin: 0;}
		nav{float:left;width:91%;overflow-x:scroll;padding: 2%;display:flex;flex:1;display:flex;margin-left: 2%;border-bottom: 2px solid #f4981d;}
		nav a{float: left;margin-right: 15px;font-size: 17px;text-decoration: none;color: #f4981d;flex: 0 0 auto;position: relative;font-weight: 700;text-transform: uppercase;}
		...
		.published-date{float: left;width: 100%;font-size: 12px;margin: 0 0 15px;color: #f4981d;padding-bottom: 7px;}
		.social-icons , .article-image{float:left;width:100%;margin-bottom: 10px;}
		.social-icons amp-social-share{border-radius: 5px;}
		.article-content{width: 100%;float: left;font-family: domine;line-height: 1.7;font-size: 16px;text-align: justify;}
		.tags{float:left;width:100%;margin-bottom: 10px;}
		.tags span{float:left;margin-right: 10px;}
		.tags a{margin: 0px 6px 5px;text-decoration: none;background: #f4981d;color: #fff;padding: 1px 5px 2px;border-radius: 5px;float:left;}
		...
		.more-stories{float: left;width: 100%;flex: 1;display: flex;overflow-x: scroll;padding: 15px 0 15px;border-top: 2px solid #f4981e;border-bottom: 2px solid #f4981e;}
		...
		.more-stories .items h4{margin: 3px 0 3px;font-weight: normal;float: left;width: 100%;}
		footer{float: left;width: 96%;padding: 2%;background: #333;color: #f4981d;margin-top: 3%;}
	...
	<body>
		...
		<div style="max-width: 600px; margin: 0 auto;">
			<header>
				...
				<a class="logo_img" href="<?php echo BASEURL; ?>"><amp-img src="<?php echo image_url.'images/FrontEnd/images/NIE-logo21.jpg'; ?>" alt="" height="38" width="124"></amp-img></a>
				<div class="social-icons-n">
					<a target="_blank" href="https://www.facebook.com/edexnie/"><amp-img src="<?php echo image_url.'images/amp-icons/facebook-is1.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a  target="_blank"href="https://twitter.com/xpress_edex"><amp-img src="<?php echo image_url.'images/amp-icons/twitter-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
					<a target="_blank" href="https://www.instagram.com/edexliveinsta/"><amp-img src="<?php echo image_url.'images/amp-icons/instagram-is.png'; ?>" alt="" height="24" width="24"></amp-img></a>
				</div>
				<hr>
			</header>
			<nav>
			...
			<section>
				...
				<div class="article-content">
					<?php
						...
						if(isset($advUnit['between_article']) && $advUnit['between_article']!=''){
							$html = new domDocument;
							//$html->loadHTML($finalcontent);
				...
				?>
				<amp-ad width=1 height=1 type="doubleclick" data-slot="/3167926/EDEX_AMP_Interstitial_1x1"></amp-ad>
				...
				<amp-sticky-ad layout="nodisplay">
					<amp-ad width="300" height="50" type="doubleclick" data-slot="/3167926/Edex_AMP_Sticky_320x50"   rtc-config='{"vendors": { "aps": {"PUB_ID": "600", "PUB_UUID": "c3703fef-358e-4353-a111-eb049ab39167", "PARAMS":{"amp":"1"}} }}'></amp-ad>
				</amp-sticky-ad>
			</section>
			<footer>
				<p>Copyright - edexlive.com<?php echo ' '.date('Y') ?> </p>
				...
				<a href="https://www.cinemaexpress.com/" rel="follow">Cinema Express  | </a>
